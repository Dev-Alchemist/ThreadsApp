...
res.locals.filterUserHTML = function(content){
    return sanitizeHTML(markdown(content), {allowedTags: ['p', 'br', 'ul', 'ol', 'li', 'strong', 'bold','i', 'em','h1','h2','h3','h4','h5'],allowedAttributes: {}})
}
...
app.set('views', 'views')
app.set('view engine', 'ejs') // let express template engine we're using
...
// makes express session data available from within the context of socket.io
